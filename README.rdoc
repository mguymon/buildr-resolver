...
A Java Dependency Resolver for {Buildr}[https://github.com/apache/buildr] using Maven's {Aether}[https://github.com/sonatype/sonatype-aether] via {Naether}[https://github.com/mguymon/naether] wrapper.
