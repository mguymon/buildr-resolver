...
A Java Dependency Resolver for Buildr using Maven's Aether via the Naether wrapper
...
Presently requires a recent JRuby runtime and requires Buildr and Naether.
