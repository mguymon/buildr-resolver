...
The <tt>Buildr::Resolver.resolve(deps)</tt> is what takes the activemq dependency and resolves 
all the additional dependencies for it. If you added a <tt>puts dep</tt> after <tt>Buildr::Resolver.resolve</tt>, it would output:
